  ...
  <svg width="1200" height="675" viewBox="0 0 1200 675" xmlns="http://www.w3.org/2000/svg">
    <defs>
      ...
      <radialGradient id="pinkGlow">
        <stop offset="0" stop-color="#fffaf5" stop-opacity="0.75"/>
        <stop offset="1" stop-color="#fffaf5" stop-opacity="0"/>
      </radialGradient>

      <filter id="shadow" x="-20%" y="-20%" width="140%" height="140%">
        <feDropShadow dx="0" dy="12" stdDeviation="15" flood-color="#514b4e" flood-opacity="0.22"/>
      </filter>
    ...
    <style>
      ...
      .eyebrow { font-size: 14px; font-weight: 700; letter-spacing: 3px; fill: #6b6568; }
      .brand { font-size: 42px; font-weight: 800; letter-spacing: 1.5px; fill: #4e494c; }
      .brandPink { fill: #9f707b; }
      .small { font-size: 15px; font-weight: 600; fill: #625d60; }
      .micro { font-size: 13px; font-weight: 600; fill: #756f72; letter-spacing: 0.5px; }
      .leftSmall { font-size: 15px; font-weight: 600; fill: #eee8e6; }
      .leftMicro { font-size: 13px; font-weight: 600; fill: #d9d1d2; letter-spacing: 0.5px; }
      .buyer { font-size: 21px; font-weight: 800; fill: #fffaf8; }
      .cashLabel { font-size: 17px; font-weight: 800; letter-spacing: 4px; fill: #6d666a; }
      .cashValue { font-size: 91px; font-weight: 800; fill: url(#pinkMetal); letter-spacing: -4px; }
      .itemName { font-size: 29px; font-weight: 800; fill: #4e494c; }
      .itemMeta { font-size: 16px; font-weight: 600; fill: #756e72; }
      .statLabel { font-size: 13px; font-weight: 700; letter-spacing: 1.7px; fill: #766f72; }
      .statValue { font-size: 32px; font-weight: 800; fill: #4e494c; }
      .pink { fill: #986a75; }
      .placeholder { font-size: 16px; font-weight: 700; fill: #776f72; }
    </style>
    ...
    <g mask="url(#ticketMask)" filter="url(#shadow)">
      ...
      <path d="M20 20 H460 V655 H20 Z" fill="#6c676a" opacity="0.96"/>
      <path d="M933 20 H1180 V188 L1095 151 Z" fill="#ffffff" opacity="0.2"/>
      <path d="M20 570 C180 528 300 694 484 625 L484 675 H20 Z" fill="#d9b3b9" opacity="0.15"/>
    </g>

    <rect x="22" y="22" width="1156" height="631" rx="40"
      fill="none" stroke="#777174" stroke-opacity="0.48" stroke-width="2"/>

    <path d="M1088 75 l7 20 20 7-20 7-7 20-7-20-20-7 20-7z"
      fill="#777174" opacity="0.8"/>

    <path d="M1027 162 c-15-18-45-3-34 21 9 20 34 31 34 31s25-11 34-31c11-24-19-39-34-21z"
      fill="none" stroke="#a97883" stroke-width="4" opacity="0.55"/>

    <circle cx="1115" cy="205" r="3" fill="#777174"/>
    <circle cx="1132" cy="188" r="5" fill="#a97883"/>

    <rect x="70" y="48" width="170" height="33" rx="16"
      fill="#ffffff" fill-opacity="0.13"
      stroke="#eee4e2" stroke-opacity="0.5"/>

    <circle cx="90" cy="64.5" r="4" fill="#d8b0b6"/>
    <text x="104" y="70" class="leftMicro">NEW PURCHASE</text>
    ...
    <path d="M70 112 Q70 82 100 82 H378 Q414 82 414 118 V430 L358 492 H100 Q70 492 70 462 Z"
      fill="none" stroke="url(#pearl)" stroke-opacity="0.75" stroke-width="3"/>

    <path d="M358 492 L414 430 H358 Z"
      fill="#d8b0b6" fill-opacity="0.24"
      stroke="#e9d9d8" stroke-opacity="0.7"/>

    <rect x="87" y="102" width="110" height="34" rx="17"
      fill="#5c575a" fill-opacity="0.88"
      stroke="#fff8f5" stroke-opacity="0.35"/>

    <text x="142" y="125" text-anchor="middle" class="leftMicro">${itemKind}</text>

    <g clip-path="url(#avatarClip)">
      ${imageOrPlaceholder(avatar, 327, 506, 84, 84, "")}
    </g>

    <circle cx="369" cy="548" r="43" fill="none" stroke="#d7afb5" stroke-width="3"/>
    <circle cx="369" cy="548" r="48" fill="none" stroke="#fff8f5" stroke-opacity="0.18"/>

    <text x="70" y="534" class="leftMicro">DIBELI OLEH</text>
    <text x="70" y="566" class="buyer">${escapeXml(truncate(buyer, 20))}</text>
    <text x="70" y="591" class="leftSmall">@${escapeXml(truncate(purchase.robloxUsername, 22))}</text>
    <text x="70" y="620" class="leftMicro">ROBLOX ID ${purchase.robloxUserId}</text>

    <line x1="455" y1="63" x2="455" y2="612"
      stroke="#665f63" stroke-opacity="0.35"
      stroke-width="2" stroke-dasharray="4 13"/>

    <circle cx="455" cy="43" r="5" fill="#a97883"/>
    <circle cx="455" cy="632" r="5" fill="#a97883"/>

    <text x="495" y="81" class="brand">
      NEKO<tspan class="brandPink">BUX</tspan>
    </text>

    <text x="495" y="109" class="eyebrow">CASHBACK SHOP 20%</text>

    <rect x="984" y="58" width="140" height="42" rx="21"
      fill="#ffffff" fill-opacity="0.32"
      stroke="#6b6568" stroke-opacity="0.3"/>
    ...
    <path d="M995 187 q28-38 57 0 q29-38 57 0 c0 42-57 73-57 73s-57-31-57-73z"
      fill="none" stroke="#a97883"
      stroke-opacity="0.28" stroke-width="7"/>

    <line x1="495" y1="300" x2="1125" y2="300"
      stroke="#6f696c" stroke-opacity="0.24"/>
    ...
    <rect x="495" y="402" width="630" height="3" rx="1.5"
      fill="#6f696c" fill-opacity="0.18"/>

    <rect x="495" y="402"
      width="${Math.max(70, Math.min(630, purchase.cashbackRobux * 9))}"
      height="3" rx="1.5" fill="url(#pinkMetal)"/>
    ...
    <line x1="685" y1="458" x2="685" y2="548"
      stroke="#6f696c" stroke-opacity="0.2"/>
    ...
    <line x1="914" y1="458" x2="914" y2="548"
      stroke="#6f696c" stroke-opacity="0.2"/>
    ...
    <rect x="495" y="578" width="630" height="1"
      fill="#6f696c" fill-opacity="0.22"/>

    <text x="495" y="615" class="small">SHOP MORE  •  SPEND LESS</text>

    <text x="1125" y="615" text-anchor="end" class="micro">
      ${escapeXml(date)} WIB
    </text>

    <text x="1125" y="637" text-anchor="end" class="micro">
