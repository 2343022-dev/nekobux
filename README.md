...
`COMMUNITY_CHANNEL_ID` adalah channel berisi link map dan Community Roblox. Setelah verifikasi, bot akan menampilkan mention dan tombol yang langsung membuka channel tersebut.
